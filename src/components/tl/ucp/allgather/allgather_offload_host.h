...
#ifndef ALLGATHER_OFFLOAD_HOST_H_
#define ALLGATHER_OFFLOAD_HOST_H_
               ...
               size_t data_len)
{
    ...
    allgather_offload_dpu_done_t *args = (allgather_offload_dpu_done_t *)data;
...
static int register_allgather_host_notifications(dpu_offload_ev_sys_t *ev_sys)
{
    int rc;
...
#endif //ALLGATHER_OFFLOAD_HOST_H_
